<h1 align="center">👋 Hi, I'm Kitthiphat</h1>
...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=4000&pause=1000&color=3B82F6&center=true&vCenter=true&width=600&lines=Full+Stack+Developer;AI+%26+Automation+Enthusiast;Open+Source+Contributor;Always+Learning+New+Things" alt="Typing SVG" />
</p>
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,js,ts,cs,dotnet,react,nextjs,nodejs,express,flask,fastapi" alt="Languages & Frameworks" />
  <br/>
  <img src="https://skillicons.dev/icons?i=html,css,tailwind,bootstrap,mysql,postgresql,mongodb,redis,docker,git" alt="Tools & Technologies" />
  <br/>
  <img src="https://skillicons.dev/icons?i=vscode,visualstudio,github,vercel,cloudflare,selenium,postman" alt="Development Tools" />
</p>
...
- 🔍 **E-commerce Price Scraper** - Web scraping tool for price monitoring
...
![GitHub Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=kitthiphatn&theme=tokyo-night&hide_border=true&area=true)
...
```javascript
const currentFocus = {
  learning: ["Cloud Architecture", "Microservices", "AI/ML Integration"],
  building: ["Full Stack Web Apps", "Automation Tools", "AI Chatbots"],
  improving: ["System Design", "Code Quality", "DevOps Practices"],
  exploring: ["Cloudflare Tunnels", "Docker Containers", "CI/CD Pipelines"]
};
